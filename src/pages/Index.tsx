...
const Marquee = () => (
  <div className="bg-nobel-gold text-ui-blue py-2 overflow-hidden relative z-40 cursor-default mt-[72px] md:mt-[88px]" role="marquee" aria-label="University of Ibadan Students' Union slogans">
