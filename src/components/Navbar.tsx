...
export const Navbar = ({ isMenuOpen, setIsMenuOpen, user, handleLogout }: NavbarProps) => {
  ...
  return (
    <>
      {/* --- DESKTOP NAVBAR --- */}
      <nav className="hidden md:block fixed top-0 left-0 w-full z-50 bg-ui-blue/95 backdrop-blur-md border-b border-white/10 shadow-sm transition-all duration-300">
