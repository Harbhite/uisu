...
export const Navbar = ({ isMenuOpen, setIsMenuOpen, user, handleLogout }: NavbarProps) => {
  ...
  return (
    <>
      {/* --- DESKTOP NAVBAR --- */}
      <nav className="hidden md:flex fixed top-4 left-0 right-0 mx-auto w-[95%] max-w-7xl z-50 justify-center transition-all duration-300 no-print -mb-[80px]">
      ...
      <nav className="md:hidden fixed top-4 left-0 right-0 mx-auto w-[90%] max-w-sm z-50 no-print -mb-[70px]">
